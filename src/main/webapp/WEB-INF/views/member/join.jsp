				...
				<div class="col-md-7">
					...
					<div class="billing-details">
						...
						<form id="joinFrm" name="join_member_form">
							...
							<div class="form-group">
								<input class="input" type="password" name="m_pw"
									placeholder="Password">
							</div>
							<div class="form-group">
								<input class="input" type="password" name="m_pw_check"
									placeholder="Password Check">
							</div>
							<div class="form-group">
								<input class="input" type="text" name="m_name"
									placeholder="Name">
							</div>
							<div class="form-group">
								<input class="input" type="text" name="m_mail"
									placeholder="E-mail">
							</div>
